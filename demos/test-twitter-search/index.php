...
$twitter = new Twitter('thinkphp','nopass');
...
<form id="f" name="f">
  <label for="search">Search:</label><input type="text" id="search" name="search" value="<?php echo$_GET['search'];?>"/><input type="submit" value="Go">
</form>  
               ...
               new ScrollLoader({
                   onScroll: function() {
                        ...
                        (function() {
                           ...
                           }).get({'page': page, 'search': "<?php echo$search;?>"});
                        }).delay(1000);                            
                   }
               });  
         });
